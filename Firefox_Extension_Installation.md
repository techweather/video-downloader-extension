...
## Media Downloader Connector v1.0
...
4. Navigate to the project folder and select one of:
   - `dist/extension/media-downloader-connector-firefox-v1.0.zip` (built package)
...
1. **Extract the extension**:
   ```bash
   cd dist/extension
   unzip media-downloader-connector-firefox-v1.0.zip -d media-downloader-connector
   ```
...
2. **Submit for Signing**:
   - Upload `media-downloader-connector-firefox-v1.0.zip`
